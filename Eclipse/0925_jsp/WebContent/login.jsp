...
.login .loginHeader .keyboard {
    text-align: right;
}

.login .loginHeader .keyboard .btnKey.korean {
    display: inline-block;
    margin: 0 14px 0 0;
}
.login .loginHeader .keyboard .btnKey {
    position: relative;
    margin: 0 0 0 12px;
...
.login .xans-member-login .login fieldset {
    position: relative;
}
img, fieldset {
    border: 0;
...
.login .loginHeader .keyboard .btnKey.special {
    display: inline-block;
    margin: 0;
}
.login .loginHeader .keyboard .btnKey {
...
.login .loginHeader .view {
    text-align: center;
}

.login .loginHeader .view > div {
    display: none;
    padding: 0 0 14px;
}

.login .xans-member-login .login fieldset .id, .login .xans-member-login .login fieldset .password {
    display: block;
    margin: 10px 0 0;
}
label {
...
.login .xans-member-login .login fieldset input[type=text], .login .xans-member-login .login fieldset input[type=password] {
    width: 100%;
    height: 36px;
    line-height: 36px;
    padding: 0 10px;
...
.login .xans-member-login .option {
    padding: 20px 0 20px;
}

.login .xans-member-login .option .item {
    display: inline-block;
    float: left;
    margin: 0 13px 0 0;
}

.login .xans-member-login .mButton {
    display: -webkit-flex;
    display: -ms-flex;
    display: flex;
	width: 100%;
...
.login .xans-member-login .option .item input[type="checkbox"]:checked {
    background-image: url(https://moma-img.echosting.cafe24.com/img/1/0189/bg_checkbox_checked.png);
}

.login .xans-member-login .option .item input[type="checkbox"] {
    width: 20px;
    height: 20px;
    border: 0;
    -webkit-appearance: none;
...
.login .xans-member-login .login fieldset input[type=checkbox] + label {
    margin: 0 0 0 10px;
    vertical-align: top;
}
.login .xans-member-login .option .item label {
    font-size: 13px;
    color: #000;
}

.login .xans-member-login .btnLogin {
    display: inline-block;
    -webkit-flex: 1;
    -ms-flex: 1;
    -moz-flex: 1;
...
.login .xans-member-login .login fieldset ul.util {
    display: -webkit-flex;
    display: -ms-flex;
    display: -moz-flex;
    display: flex;
...
.login .xans-member-login .login fieldset li {
    -webkit-flex: 1;
    -ms-flex: 1;
    -moz-flex: 1;
    flex: 1;
...
.login .xans-member-login .login fieldset li a {
    position: relative;
    display: block;
    padding: 0;
    line-height: 40px;
...
.login .snsArea li:nth-child(2n+1) {
    margin-right: 10px;
}
.login .snsArea li {
    display: inline-block;
